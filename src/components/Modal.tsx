...
/**
 * TODO: Add navigation to next and previous image within the modal
 * TODO: Making images stay in place when scrolling
 * TODO: Fetch the full image when user clicks on the image, and zoom out when clicked again
 */
                ...
                <div className="max-h-full min-w-[90vw] max-w-screen-md overflow-hidden border-none shadow-lg absolute left-1/2 -translate-x-1/2 flex flex-col pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                  ...
                  <div className="overflow-y-scroll scrollbar-hide relative mx-auto bg-slate-800 w-full h-auto aspect-square">
                    <div className="relative p-10 mx-auto flex items-center justify-center">
                      <img
                        className={`rounded-lg cursor-zoom-in w-fit
                        `}
                        src={
                          clicked
                            ? query.data?.urls?.full
                            : query.data?.urls?.regular
                        }
                        alt="selected photo"
                    ...
                    <div className="flex justify-center items-center">
                      <div className="relative bottom-0 max-w-2xl flex flex-1 space-x-2 pt-2 whitespace-nowrap overflow-x-scroll scrollbar-hide">
